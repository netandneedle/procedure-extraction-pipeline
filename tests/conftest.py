...
def sample_drafts():
    ...
    drafts = [
        ...
        asdict(ProcedureDraft(
            ...
            techniques=[
                TechniqueMapping(stix_id="attack-pattern--d1fcf083-a721-4223-aedf-bf8960798d62", technique_id="T1059.003", technique_name="Windows Command Shell", tactic="execution", confidence=0.82),
                TechniqueMapping(stix_id="attack-pattern--e6919abc-99f9-4c6c-95a5-14761e7b2add", technique_id="T1105", technique_name="Ingress Tool Transfer", tactic="command-and-control", confidence=0.79),
            ],
